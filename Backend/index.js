...
const app = express();
app.use(cors({
    origin: ['http://localhost:8001','http://192.168.1.6:8001', 'http://127.0.0.1:8001','http://192.168.137.1:8001','http://65.2.178.70:8001','http://15.207.141.92:8001','http://3.7.111.35:8001','http://PerformAce-alb-1441902511.ap-south-1.elb.amazonaws.com:8001'],
}));
