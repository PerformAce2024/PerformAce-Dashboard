...
const fetchGeoPerformanceData = async (campaignId) => {
    try {
        ...
        const apiUrl = `http://15.207.100.193:8000/api/taboola/getAllStatesByClicks/${campaignId}`;
        ...
        if (!responseData.allStatesData || !Array.isArray(responseData.allStatesData) || responseData.allStatesData.length === 0) {
