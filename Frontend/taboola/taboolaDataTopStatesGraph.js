...
const fetchTop7StatesData = async (campaignId) => {
  try {
    // const apiUrl = `https://backend-api.performacemedia.com:8000/api/taboola/getTop7States/${campaignId}`;
    const apiUrl = `${config.BASE_URL}/api/taboola/getTop7States/${campaignId}`;
