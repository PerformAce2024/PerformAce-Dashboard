document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const clientsResponse = await fetch('http://backend-api.performacemedia.int:8000/api/get-clients', {
            method: 'GET',
            headers: {
...
async function setupRODropdown(clientId) {
    ...
    try {
        ...
        const roResponse = await fetch('http://backend-api.performacemedia.int:8000/api/get-ros', {
            method: 'GET',
            headers: {
...
async function submitCampaign(clientId, clientName, clientEmail) {
    ...
    try {
        const submitResponse = await fetch('http://backend-api.performacemedia.int:8000/api/submit-campaign', {
            method: 'POST',
